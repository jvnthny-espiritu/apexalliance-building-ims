...
// npm install @heroicons/react/20/solid
...
export default function Filter() {
  ...
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <Menu.Items className="absolute left-0 z-10 mt-2 w-56 origin-top-left rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-70 focus:outline-none">
          <div className="py-1">
